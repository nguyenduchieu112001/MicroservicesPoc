...
internal static class DemoProductFactory
{
    internal static Product Travel()
    {
        var p = Product.CreateDraft(
            "TRI",
            "Safe Traveller",
            "/41095f80-6681-460f-9c68-6eba4b399e3e.jpg",
            "Travel insurance",
            10,
            "plane");
    ...
    internal static Product House()
    {
        var p = Product.CreateDraft(
            "HSI",
            "Happy House",
            "/4cc185b0-b7d8-45e8-9a6a-13422eca5688.jpg",
            "House insurance",
            5,
            "building");
    ...
    internal static Product Farm()
    {
        var p = Product.CreateDraft(
            "FAI",
            "Happy farm",
            "/9fc14847-5106-449c-959b-cb109175ec1f.jpg",
            "Farm insurance",
            1,
            "apple");
    ...
    internal static Product Car()
    {
        var p = Product.CreateDraft(
            "CAR",
            "Happy Driver",
            "/7b793ad3-bdbe-4e2e-ac6a-8081008ccd20.jpg",
            "Car insurance",
            1,
            "car");
